...
folders_to_create = ['accessible', 'browser', 'build', 'caps', 'docshell', 'dom', 'extensions', 'gfx', 'intl', 'ipc']
...
# source_folder = 'gecko-dev-master' Download from https://github.com/mozilla/gecko-dev/tree/master
